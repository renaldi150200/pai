            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>Materi Tersedia Seperti Sholat , Wudhu dan Janaiz</p>
                    </div>
                </div>
                <!-- end of card -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>Praktik Tersedia Seperti Sholat , Wudhu dan Janaiz</p>
                    </div>
                </div>
                <!-- end of card -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>Evaluasi di dapat dari Mentor Profesioal</p>
                    </div>
                </div>
                <!-- end of card -->
                ...
                <div class="footer-col middle">
                    ...
                    <ul class="list-unstyled li-space-lg p-small">
                        <li class="media">
                            ...
                            <div class="media-body">Universitas Mulawarman <a class="white text-decoration-none" href="https://unmul.ac.id/">Unmul.ac.id</a></div>
                        </li>
