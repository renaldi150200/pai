        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="#absensi"><span class="list-nav">Amalan Yaumiyah</span> </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="#materi"><span class="list-nav">Materi</span> </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="#kelas"><span class="list-nav">Kelas</span></a>
                    </li>
                </ul>
                <span class="nav-item">
