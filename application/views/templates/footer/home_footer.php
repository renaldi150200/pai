                 ...
                 <div class="footer-col middle">
                     ...
                     <ul class="list-unstyled li-space-lg p-small">
                         <li class="media">
                             ...
                             <div class="media-body">Universitas Mulawarman <a class="white" href="https://unmul.ac.id/">Unmul.ac.id</a></div>
                         </li>
                 ...
                 <div class="footer-col last">
                     ...
                     <ul class="list-unstyled li-space-lg p-small">
                         ...
                         <li class="media">
                             ...
                             <div class="media-body"><a class="white">pai.unmul@gmail.com</a> </div>
                         </li>
                         <li class="media ml-n3">
                             <i class="fas fa-globe"></i>
                             <div class="media-body"><a class="white" href="#your-link">www.paiunmul.com</a></div>
                         </li>
                     </ul>
                 </div>
             </div> <!-- end of col -->
